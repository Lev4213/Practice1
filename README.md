...
2) Введите последовательность команд:
   <br/>git clone https://github.com/Lev4213/Practice1 && cd Practice1  (Если выдаёт ошибку,то введите эту команду вместо предыдущей: git clone https://github.com/Lev4213/Practice1.git && cd Practice1 )
